# iac_terraform_aws_ec2_file_provisioner

Terraform script to create a simple EC2 instance with file provisioner.
...
```
$ cd terraform_scripts/iac_terraform_aws_ec2_file_provisioner
$ terraform init
